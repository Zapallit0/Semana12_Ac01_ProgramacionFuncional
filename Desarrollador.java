...
public class Desarrollador {private String codigo;
    ...
    public Desarrollador(String codigo, String nombres, String apellidos, int salario, int totalLaptopsAsignados, List<Iniciativa> iniciativas) {
        this.codigo = codigo;
